...
function finishSelected(){
	...
	nextDIV.innerHTML = "<a href=\"/getDiaTiComTiTable?did="+id+"&locationDes="+dlocation+"&comparetype="+comparetype+"&compareentity="+compareentity+"&queryStrList="+result+"\" class=\"button button-block button-rounded button-primary button-large\">下一步</a>";
};
